...
<div class="container">
	<form action="" id="form_personal" data-lugar="dias2/db_" data-funcion="guardar_dias">
				...
				<div class="row">
					<div class="col-12">
						<div class="btn-group">
							...
							<button class='btn btn-outline-secondary btn-sm' id='lista_penarea' data-lugar='dias2/lista' title='regresar'><i class='fas fa-undo-alt'></i>Regresar</button>
						</div>
					</div>
				</div>
			</div>
